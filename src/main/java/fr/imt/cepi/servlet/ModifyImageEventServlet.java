...
@MultipartConfig
@WebServlet(name = "Modify_Image_Event", urlPatterns = {"/Modify_Image_Event"})
public class ModifyImageEventServlet extends HttpServlet{
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (rs != null && rs.next()) {
                ...
                request.setAttribute("message", "<font color=green>" + "La photo de l'evenement a ete modifie.  " + "</font>");
