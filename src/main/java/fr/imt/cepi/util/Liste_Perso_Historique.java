...
public class Liste_Perso_Historique implements Serializable {

	private static final long serialVersionUID = 6297385302078200511L;

	public ArrayList<Evenement> liste = new ArrayList();

	public Liste_Perso_Historique(HttpServletRequest request) {
	...
	public String getEventPersoHistorique() {
		String fin="";
